...
import { removeExplicitReturnTypeCommand } from './commands/remove-explicit-return-type/remove-explicit-return-type.command';
...
export function activate(context: vscode.ExtensionContext) {
    [toArrowSyntaxCommand, removeExplicitReturnTypeCommand].forEach(
        refactorCommand => {
